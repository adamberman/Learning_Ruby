class Hand
  # This is called a *factory method*; it's a *class method*
  # that takes a `Deck` object and creates a `Hand` object.
  # This is in contrast to the `#initialize` method that
